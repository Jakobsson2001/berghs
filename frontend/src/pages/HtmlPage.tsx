...
<img src="headshot.jpg" alt="Portrait of me smiling" />`}</code>
        ...
        <Typography variant="h3" sx={{ fontSize: '20px', mt: 3, mb: 1, color: 'var(--text)' }}>
          Where to Store Images (Static Files)
        </Typography>
        <Typography variant="body1" sx={{ mb: 2, color: 'var(--text)', lineHeight: 1.7 }}>
          For static images that never change (logos, icons, backgrounds), store them in your frontend's <code>public/images/</code> folder. These files are served directly by your frontend server.
        </Typography>
...
└── src/
    └── App.tsx`}</code>
          ...
          <Typography variant="body2" sx={{ mt: 1.5, color: 'var(--muted)' }}>
            Use in your HTML: <code>&lt;img src="/images/logo.png" alt="Company logo" /&gt;</code>
          </Typography>
        </Paper>
        ...
        >
          ...
          <Typography sx={{ m: 0, mt: 0.5 }}>
            This covers static files in the frontend. For user uploads, backend file storage, and cloud storage options, see the complete <MuiLink component={Link} to="/file-storage" sx={{ color: 'var(--accent)' }}>File Storage guide</MuiLink>.
          </Typography>
        </Box>
