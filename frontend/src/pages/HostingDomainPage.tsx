      ...
      >
        ...
        <Paper sx={{ background: 'rgba(2, 6, 23, 0.6)', border: '1px solid var(--border)', borderRadius: 3, p: 2.5, my: 2.5 }}>
          ...
          <List sx={{ m: '12px 0', pl: 2.5 }}>
            ...
            <ListItem sx={{ display: 'list-item', pl: 0 }}>
              <ListItemText primary={<><strong>YC Startup Playbook</strong> — Comprehensive guide to building startups (see our <MuiLink href="/startup-journey" sx={{ color: 'var(--accent)' }}>Startup Journey page</MuiLink> for more)</>} />
            </ListItem>
            <ListItem sx={{ display: 'list-item', pl: 0 }}>
        ...
        >
          ...
          <Typography sx={{ m: 0, mt: 0.5 }}>
            While YC doesn't directly provide hosting, they help startups by providing credits and partnerships with major cloud providers. For early-stage startups, platforms like Render (which we use in this course) are often sufficient and free. As companies grow, they may leverage YC's partner credits for more advanced infrastructure needs. The key is to start simple and scale as needed.
          </Typography>
        </Box>
